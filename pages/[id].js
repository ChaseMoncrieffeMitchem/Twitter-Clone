  ...
  return (
    <div>
      ...
      >
        ...
        >
          <div className="flex space-x-2px-3 py-2 text-lg sm:text-xl font-bold *:border-b border-gray-700 sticky top-0 z-50">
            <Link href={"/"}>
          ...
          <div className="flex justify-between items-center border-b border-gray-700 p-2">
            ...
            <button
              disabled={true}
              className="bg-[#1d9bf0] rounded-full px-6 py-1.5
            disabled:opacity-50"
            >
              Tweet
            </button>
